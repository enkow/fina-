<template>
	<AnnouncementContent
		...
		name="price_non_zero_announcement">
		<template #icon>
			<MessageIcon />
		</template>

		<template #title>
			{{ setting.feature.translations['price-non-zero-setting-title'] }}
		</template>

		{{ setting.feature.translations['price-non-zero-setting-description'] }}
		<Link
...
import AnnouncementContent from '@/Components/Dashboard/Settings/Types/AnnouncementContent.vue';
