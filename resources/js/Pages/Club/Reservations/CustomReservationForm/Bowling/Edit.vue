<template>
	...
	<div
		...
		<SimpleSelect
			...
			:disabled="isTimerEnabled || isPaid"
			:readonly="isPaid"
	...
	<div
		...
		<div v-if="form.errors[`features.${features.price_per_person[0].id}.person_count`]" class="error">
	...
	<div class="col-span-4 space-y-2">
		...
		<TextInput
			v-model="form.price"
			:disabled="form.club_reservation || isTimerEnabled || isPaid"
			:readonly="isPaid"
	...
	<div class="col-span-4 space-y-2" v-if="form.status === 0 || reservation.payment_method_online == false">
...
import { capitalize, computed, toRaw, watch } from 'vue';
...
import { ref } from 'vue';
import { Game, Reservation, SelectOption } from '@/Types/models';
