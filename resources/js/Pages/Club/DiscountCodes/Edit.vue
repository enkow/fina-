<template>
	<PanelLayout
		:breadcrumbs="[
			...
			{
				href: route('club.discount-codes.edit', {
					discount_code: discountCode,
				}),
				label: $t('discount-code.code') + ' ' + discountCode.code,
			},
		]">
		<ContentContainer>
			<div class="col-span-12 xl:col-span-9">
				<Card>
					...
					<form
						...
						@submit.prevent="
							form.put(
								route('club.discount-codes.update', {
									discount_code: props.discountCode.id,
								}),
							)
						">
						...
						<div class="col-span-4 flex items-center justify-end">
							<Checkbox id="active" v-model="form.active" :checked="form.active" />
							<InputLabel :value="$t('discount-code.set-as-active')" class="ml-3" for="active" />
						</div>
...
const userGameOptions = gameOptions();

const form = useForm({
	active: props.discountCode.active,
	game_id: props.discountCode.game?.id,
	type: props.discountCode.type,
	code: props.discountCode.code,
	value: props.discountCode.value,
	code_quantity: props.discountCode.code_quantity,
	code_quantity_per_customer: props.discountCode.code_quantity_per_customer,
	start_at: props.discountCode.start_at,
	end_at: props.discountCode.end_at,
});
</script>
