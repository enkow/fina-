...
return [
	...
	'backup_successful_body' =>
		'朗報です。ディスク :disk_name へ :application_name のバックアップが成功しました。',
	...
	'cleanup_successful_body' =>
		'ディスク :disk_name に保存された :application_name のバックアップ削除に成功しました。',
	...
	'unhealthy_backup_found_subject_title' =>
		'重要: :application_name のバックアップに異常があります。 :problem',
	...
	'unhealthy_backup_found_full' =>
		'バックアップがディスク容量を圧迫しています。現在の使用量 :disk_usage　は、許可された限界値 :disk_limit を超えています。',
