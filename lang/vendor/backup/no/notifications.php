...
return [
	...
	'backup_successful_body' =>
		'Gode nyheter, en ny backup av :application_name ble opprettet på disken :disk_name.',
	...
	'cleanup_successful_body' =>
		'Oppryddingen av backup for :application_name på disken :disk_name har blitt gjennomført.',
	...
	'unhealthy_backup_found_full' =>
		'Backups bruker for mye lagringsplass. Nåværende diskbruk er :disk_usage, som er mer enn den tillatte grensen på :disk_limit.',
