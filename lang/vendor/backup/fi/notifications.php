...
return [
	...
	'cleanup_successful_body' =>
		':application_name varmuuskopiot poistettu onnistuneesti levyltä :disk_name.',
	...
	'unhealthy_backup_found_subject_title' =>
		'HUOM!: :application_name varmuuskopiot ovat vialliset. :problem',
	...
	'unhealthy_backup_found_full' =>
		'Varmuuskopiot vievät liikaa levytilaa. Tällä hetkellä käytössä :disk_usage, mikä on suurempi kuin sallittu tilavuus (:disk_limit).',
