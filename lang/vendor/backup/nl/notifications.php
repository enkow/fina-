...
return [
	...
	'backup_failed_body' =>
		'Belangrijk: Er ging iets fout tijdens het maken van een back-up van :application_name',
	...
	'backup_successful_body' =>
		'Goed nieuws, een nieuwe back-up van :application_name was succesvol aangemaakt op de schijf genaamd :disk_name.',
	...
	'cleanup_successful_body' =>
		'Het opschonen van de :application_name back-ups op de schijf genaamd :disk_name was succesvol.',
	...
	'healthy_backup_found_body' =>
		'De back-ups voor :application_name worden als gezond beschouwd. Goed gedaan!',

	'unhealthy_backup_found_subject' =>
		'Belangrijk: De back-ups voor :application_name zijn niet meer gezond',
	'unhealthy_backup_found_subject_title' =>
		'Belangrijk: De back-ups voor :application_name zijn niet gezond. :problem',
	'unhealthy_backup_found_body' =>
		'De back-ups voor :application_name op schijf :disk_name zijn niet gezond.',
	...
	'unhealthy_backup_found_full' =>
		'De back-ups gebruiken te veel opslagruimte. Momenteel wordt er :disk_usage gebruikt wat hoger is dan de toegestane limiet van :disk_limit.',
