...
return [
	...
	'backup_successful_body' =>
		'Gode nyheder - der blev oprettet en ny backup af :application_name på disken :disk_name.',
	...
	'cleanup_successful_body' =>
		'Oprydningen af backups for :application_name på disken :disk_name er gennemført.',
	...
	'unhealthy_backup_found_subject_title' =>
		'Vigtigt: Backups for :application_name er fejlbehæftede. :problem',
	...
	'unhealthy_backup_found_full' =>
		'Backups bruger for meget plads. Nuværende disk forbrug er :disk_usage, hvilket er mere end den tilladte grænse på :disk_limit.',
