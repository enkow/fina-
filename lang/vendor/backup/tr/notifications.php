...
return [
	...
	'backup_successful_body' =>
		'Harika bir haber, :application_name âit yeni bir yedekleme :disk_name adlı diskte başarıyla oluşturuldu.',
	...
	'unhealthy_backup_found_subject_title' =>
		'Önemli: :application_name için yedeklemeler sağlıksız. :problem',
	...
	'unhealthy_backup_found_full' =>
		'Yedeklemeler çok fazla depolama alanı kullanıyor. Şu anki kullanım: :disk_usage, izin verilen sınırdan yüksek: :disk_limit.',
