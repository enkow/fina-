...
return [
	...
	'backup_successful_body' =>
		'Boas notícias, um novo backup da aplicação :application_name foi criado no disco :disk_name.',
	...
	'cleanup_successful_body' =>
		'A limpeza dos backups da aplicação :application_name no disco :disk_name foi concluída.',
	...
	'unhealthy_backup_found_full' =>
		'Os backups estão usando muito espaço de armazenamento. A utilização atual é de :disk_usage, o que é maior que o limite permitido de :disk_limit.',
